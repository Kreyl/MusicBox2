...
public:
    ...
    void SetPwmFrequencyHz(uint32_t AFrequency) { IChnl.SetFrequencyHz(AFrequency); }
    void SetBrightness(uint16_t ABrightness) { IChnl.Set(ABrightness); }
};
#endif
